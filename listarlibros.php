...
SELECT LI.CodLibro, LI.Titulo, LI.Portada, AU.Descripcion as Autor,LI.Link,GE.Descripcion as Genero , ED.Descripcion as Editorial, LI.Ubicacion, LI.Ejemplar FROM libros LI
		...
		while ($fila = mysqli_fetch_array($resultado)) {
			echo "<tr>";
				...
				echo "<td>
					...
					<strong><p style='color:green;'>Editorial: </p></strong>" .$fila['Editorial'] ."<br><br>
					<strong><p style='color:green;'>Link: </p></strong>" .$fila['Link'];
